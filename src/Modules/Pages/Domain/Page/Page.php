...
/**
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Pages\Domain\Page\PageRepository")
 * @ORM\Table(
 *     name="PagesPage",
 *     indexes={
...
class Page
{
     ...
     * @var Meta
     *
     * @ORM\OneToOne(targetEntity="ForkCMS\Core\Common\Doctrine\Entity\Meta", cascade={"ALL"})
     ...
     * @var MediaGroup|null
     *
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\MediaLibrary\Domain\MediaGroup\MediaGroup", cascade={"ALL"})
     */
    private $image;
     ...
     * @var Status
     *
     * @ORM\Column(type="modules__pages__page__status", length=243)
     */
    private $status;
     ...
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\Pages\Domain\PageBlock\PageBlock",
     *     mappedBy="page",
     *     cascade={"remove"}
     * )
