 ...
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Pages\Domain\PageBlock\PageBlockRepository")
...
class PageBlock
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Pages\Domain\Page\Page", inversedBy="blocks")
     ...
     * @var Type
     *
     * @ORM\Column(type="modules__pages__page_block__type", name="extra_type", options={"default": "rich_text"})
     */
    private $extraType;
