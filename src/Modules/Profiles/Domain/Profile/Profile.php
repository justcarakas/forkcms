...
class Profile
{
     ...
     * @var Status
     *
     * @ORM\Column(type="modules__profiles__profile__status")
     */
    private $status;
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\Profiles\Domain\GroupRight\GroupRight",
     *     mappedBy="profile"
     * )
     */
    private $rights;
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\Profiles\Domain\Setting\Setting",
     *     mappedBy="profile",
