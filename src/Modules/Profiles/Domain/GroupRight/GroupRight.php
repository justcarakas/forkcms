...
namespace ForkCMS\Modules\Profiles\Domain\GroupRight;
 ...
 *      }
 * )
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Profiles\Domain\GroupRight\GroupRightRepository")
...
class GroupRight
{
     ...
     * @var Profile|null
     *
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Profiles\Domain\Profile\Profile", inversedBy="rights")
     */
    private $profile;
     ...
     * @var Group|null
     *
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Profiles\Domain\Group\Group", inversedBy="rights")
     */
    private $group;
