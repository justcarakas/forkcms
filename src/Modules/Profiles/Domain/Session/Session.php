...
namespace ForkCMS\Modules\Profiles\Domain\Session;
 ...
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Profiles\Domain\Session\SessionRepository")
...
class Session
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Profiles\Domain\Profile\Profile")
     */
    private $profile;
