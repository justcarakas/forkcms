...
namespace ForkCMS\Modules\Faq\Domain\Question;
...
/**
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Faq\Domain\Question\QuestionRepository")
...
class Question
{
     ...
     * @var Category
     *
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Faq\Domain\Category\Category", inversedBy="questions")
     * @ORM\JoinColumn(
     *   name="category_id",
     *   referencedColumnName="id",
     *   onDelete="cascade",
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\Faq\Domain\Feedback\Feedback",
     *     mappedBy="question",
     *     cascade={"remove"}
     * )
     */
