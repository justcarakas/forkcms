...
namespace ForkCMS\Modules\Faq\Domain\Feedback;
...
/**
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Faq\Domain\Feedback\FeedbackRepository")
...
class Feedback
{
     ...
     * @var Question
     *
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Faq\Domain\Question\Question", inversedBy="feedbackItems")
     * @ORM\JoinColumn(
     *   name="question_id",
