 ...
 * @method array<string, string[]> getCountryTimezones(string $country)
 * @method string formatCurrency($amount, string $currency, array<string, mixed> $attrs = [], string $locale = null)
 * @method string formatNumber($number, array<string, mixed> $attrs = [], string $style = 'decimal', string $type = 'default', string $locale = null)
 * @method string formatNumberStyle(string $style, $number, array<string, mixed> $attrs = [], string $type = 'default', string $locale = null)
 ...
 * @method string formatUserCurrency($amount, string $currency, array<string, mixed> $attrs = [], string $locale = null)
 * @method string formatUserNumber($number, array<string, mixed> $attrs = [], string $style = 'decimal', string $type = 'default', string $locale = null)
 * @method string formatUserNumberStyle(string $style, $number, array<string, mixed> $attrs = [], string $type = 'default', string $locale = null)
