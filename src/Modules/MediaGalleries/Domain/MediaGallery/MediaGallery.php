...
/**
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\MediaGalleries\Domain\MediaGallery\MediaGalleryRepository")
...
class MediaGallery
{
     ...
     * @var Status
     *
     * @ORM\Column(type="modules__media_galleries__media_gallery__status")
     */
    protected $status;
