...
namespace ForkCMS\Modules\MediaLibrary\Domain\MediaGroupMediaItem;
 ...
 *
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\MediaLibrary\Domain\MediaGroupMediaItem\MediaGroupMediaItemRepository")
 */
class MediaGroupMediaItem implements JsonSerializable
{
     ...
     *
     * @ORM\ManyToOne(
     *     targetEntity="ForkCMS\Modules\MediaLibrary\Domain\MediaGroup\MediaGroup",
     ...
     *
     * @ORM\ManyToOne(
     *     targetEntity="ForkCMS\Modules\MediaLibrary\Domain\MediaItem\MediaItem",
     *     inversedBy="groups",
     *     cascade="persist",
     *     fetch="EAGER"
     * )
