...
use ForkCMS\Modules\MediaLibrary\Domain\StorageProvider\LiipImagineBundleStorageProviderInterface;
 ...
 * MediaItem
 *
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\MediaLibrary\Domain\MediaItem\MediaItemRepository")
...
class MediaItem implements JsonSerializable
{
     ...
     *
     * @ORM\ManyToOne(
     *      targetEntity="ForkCMS\Modules\MediaLibrary\Domain\MediaFolder\MediaFolder",
     *      inversedBy="items",
     *      cascade="persist"
     * )
     * @ORM\JoinColumn(
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\MediaLibrary\Domain\MediaGroupMediaItem\MediaGroupMediaItem",
     *     mappedBy="item",
