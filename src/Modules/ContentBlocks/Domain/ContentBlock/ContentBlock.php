...
class ContentBlock
{
     ...
     * @var Locale
     *
     * @ORM\Column(type="modules__internationalisation__locale__locale", name="language")
     */
    private $locale;
     ...
     * @var Status
     *
     * @ORM\Column(type="modules__content_blocks__content_block__status", options={"default" = "active"})
     */
    private $status;
