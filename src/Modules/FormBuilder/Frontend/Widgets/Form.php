    ...
    private function parse(): void
    {
        ...
        if ($this->hasRecaptchaField) {
            ...
            $this->template->assign(
                ...
                FrontendModel::get(ModulesSettings::class)->get('Core', 'google_recaptcha_version', 'v2invisible')
            );
            $this->template->assign(
                'siteKey',
                FrontendModel::get(ModulesSettings::class)->get('Core', 'google_recaptcha_site_key')
            );
        }
