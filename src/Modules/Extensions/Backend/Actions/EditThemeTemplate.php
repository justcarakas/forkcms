...
class EditThemeTemplate extends BackendBaseActionEdit
{
    ...
    private function loadData(): void
    {
        ...
        $deleteAllowed = true;
        if ($this->record['id'] == $this->get(ModuleSettingRepository::class)->get('Pages', 'default_template')) {
            $deleteAllowed = false;
    ...
    private function loadForm(): void
    {
        ...
        // init var
        $defaultId = $this->get(ModuleSettingRepository::class)->get('Pages', 'default_template');
        ...
        // create elements
        $this->form->addDropdown('theme', $themes, $this->get(ModuleSettingRepository::class)->get('Core', 'theme', 'Fork'));
    ...
    private function validateForm(): void
    {
        ...
        if ($this->get(ModuleSettingRepository::class)->get('Pages', 'default_template') == $this->record['id']) {
            $item['active'] = true;
        }
        ...
        if ($this->form->getField('default')->getChecked()
            && $item['theme'] == $this->get(ModuleSettingRepository::class)->get('Core', 'theme', 'Fork')
        ) {
            $this->get(ModuleSettingRepository::class)->set('pages', 'default_template', $item['id']);
        }
