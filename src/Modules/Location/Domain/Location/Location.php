...
namespace ForkCMS\Modules\Location\Domain\Location;
 ...
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Location\Domain\Location\LocationRepository")
...
class Location
{
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="ForkCMS\Modules\Location\Domain\LocationSetting\LocationSetting",
     *     mappedBy="location",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
