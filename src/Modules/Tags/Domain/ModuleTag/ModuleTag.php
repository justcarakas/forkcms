...
namespace ForkCMS\Modules\Tags\Domain\ModuleTag;

use ForkCMS\Modules\Tags\Domain\Tag\Tag;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass="ForkCMS\Modules\Tags\Domain\Tag\TagRepository")
...
class ModuleTag
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="ForkCMS\Modules\Tags\Domain\Tag\Tag", inversedBy="moduleTags")
     */
    private $tag;
