...
CREATE TABLE `FaqCategory` (
  ...
  `locale` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__internationalisation__locale__locale)',
...
CREATE TABLE `MediaGallery` (
  ...
  `createdOn` datetime NOT NULL COMMENT '(DC2Type:datetime)',
  `editedOn` datetime NOT NULL COMMENT '(DC2Type:datetime)',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__media_galleries__media_gallery__status)',
...
CREATE TABLE `MediaGroup` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:media_library-media_group-type)',
  `editedOn` datetime NOT NULL COMMENT '(DC2Type:datetime)',
...
CREATE TABLE `MediaItem` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:guid)',
  `userId` int(11) NOT NULL,
  `storageType` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'local' COMMENT '(DC2Type:media_library-media_item-storage_type)',
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:media_library-media_item-type)',
...
CREATE TABLE `PagesModuleExtra` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__pages__module_extra__module_extra_type)',
...
CREATE TABLE `PagesPage` (
  ...
  `meta_id` int(11) DEFAULT NULL,
  `locale` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__internationalisation__locale__locale)',
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__pages__page__type)',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `navigation_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `navigation_title_overwrite` tinyint(1) NOT NULL,
  `hidden` tinyint(1) NOT NULL,
  `status` varchar(243) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__pages__page__status)',
...
CREATE TABLE `PagesPageBlock` (
  ...
  `extra_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'rich_text' COMMENT '(DC2Type:modules__pages__page_block__type)',
...
CREATE TABLE `ProfilesProfile` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__profiles__profile__status)',
...
CREATE TABLE `content_blocks` (
  ...
  `language` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules__internationalisation__locale__locale)',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `text` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hidden` tinyint(1) NOT NULL DEFAULT 0,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '(DC2Type:modules__content_blocks__content_block__status)',
  `created_on` datetime NOT NULL,
  `edited_on` datetime NOT NULL,
  PRIMARY KEY (`revision_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
