...
CREATE TABLE `FaqCategory` (
  ...
  `locale` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-internationalisation-locale-locale)',
...
CREATE TABLE `MediaGallery` (
  ...
  `createdOn` datetime NOT NULL COMMENT '(DC2Type:datetime)',
  `editedOn` datetime NOT NULL COMMENT '(DC2Type:datetime)',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-media_galleries-media_gallery_status)',
...
CREATE TABLE `PagesModuleExtra` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-pages-module_extra-module_extra_type)',
...
CREATE TABLE `PagesPage` (
  ...
  `meta_id` int(11) DEFAULT NULL,
  `locale` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-internationalisation-locale-locale)',
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-pages-page-type)',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `navigation_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `navigation_title_overwrite` tinyint(1) NOT NULL,
  `hidden` tinyint(1) NOT NULL,
  `status` varchar(243) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-pages-page-status)',
...
CREATE TABLE `PagesPageBlock` (
  ...
  `extra_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'rich_text' COMMENT '(DC2Type:modules-pages-page_block-type)',
...
CREATE TABLE `ProfilesProfile` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-profiles-profile-status)',
...
CREATE TABLE `content_blocks` (
  ...
  `language` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '(DC2Type:modules-internationalisation-locale-locale)',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `text` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hidden` tinyint(1) NOT NULL DEFAULT 0,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '(DC2Type:modules-content_blocks-content_block-status)',
  `created_on` datetime NOT NULL,
  `edited_on` datetime NOT NULL,
  PRIMARY KEY (`revision_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
